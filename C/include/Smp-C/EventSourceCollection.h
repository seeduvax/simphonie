 ...
 */
#ifndef CWRAPPER_EVENTSOURCECOLLECTION_H
#define CWRAPPER_EVENTSOURCECOLLECTION_H
...
typedef void CW(EventSourceCollection);
...
#endif /* CWRAPPER_EVENTSOURCECOLLECTION_H */
