 ...
 * $Date$
 */
#ifndef __simphonie_kern_ExEntryPointNotSubscribed_HPP__
#define __simphonie_kern_ExEntryPointNotSubscribed_HPP__
...
#endif  // __simphonie_kern_ExEntryPointNotSubscribed_HPP__
