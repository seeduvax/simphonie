...
public:
    ...
    void testPublishField() {
        Publication pub(new simph::smpdk::Object(
                                "testObj","dummy object for testing",nullptr)
                        ,nullptr);
    ...
    void testPublishArrayField() {
        ...
        pub.PublishArray("iArray","int array test pub",3,iArray,
                        Smp::PrimitiveTypeKind::PTK_Int32);
        
        Smp::ISimpleArrayField* f=
                dynamic_cast<Smp::ISimpleArrayField*>(pub.getChild("iArray"));
        CPPUNIT_ASSERT(f!=nullptr);
