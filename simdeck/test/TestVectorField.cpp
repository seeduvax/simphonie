...
private:
 ...
 void setUp() {
    ...
    dynamic_cast<Smp::IObject*>(_typeRegistry), 6, _float64Type);
 ...
 ABS_TEST_CASE_BEGIN(VectorVectorInt) {
        ...
        std::vector<Smp::Int32> v2 = {64,128,256,1028,2056,4076};
        std::vector<Smp::Int32> v3 = {1,3,5,7};
        std::vector<std::vector<Smp::Int32>*> vvint={&v1,&v2};
        auto vf=VectorField::Create("vvint","",(&vvint),_simplevectorTypeInt32,
    ...
    ABS_TEST_CASE_BEGIN(VectorArrayDouble) {
        std::array<Smp::Float64, 6> v1 = {1.0325,2.0325,4.0325,8.0325,16.0325,32.0325};
        std::array<Smp::Float64, 6> v2 = {64.0325,128.0325,256.0325,1028.0325,2056.0325,4076.0325};
        std::array<Smp::Float64, 6> v3 = {1.0325,3.0325,5.0325,7.0325,5.0325,7.0325};
        std::vector<std::array<Smp::Float64, 6>*> vadouble={&v1,&v2};
        auto vf=VectorField::Create("vadouble","",(&vadouble),_simplearrayTypeDouble,
